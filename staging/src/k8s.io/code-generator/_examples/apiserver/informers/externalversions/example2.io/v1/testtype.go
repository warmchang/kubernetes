...
import (
	...
	v1 "k8s.io/code-generator/_examples/apiserver/listers/example2.io/v1"
)
...
func (f *testTypeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&example2iov1.TestType{}, f.defaultInformer)
}
