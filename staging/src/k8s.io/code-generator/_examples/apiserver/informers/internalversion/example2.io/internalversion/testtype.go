...
import (
	...
	internalversion "k8s.io/code-generator/_examples/apiserver/listers/example2.io/internalversion"
)
...
func (f *testTypeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&example2io.TestType{}, f.defaultInformer)
}
