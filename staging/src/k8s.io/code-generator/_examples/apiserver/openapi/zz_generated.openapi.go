...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"k8s.io/code-generator/_examples/apiserver/apis/example2.io/v1.TestType":       schema_apiserver_apis_example2io_v1_TestType(ref),
		"k8s.io/code-generator/_examples/apiserver/apis/example2.io/v1.TestTypeList":   schema_apiserver_apis_example2io_v1_TestTypeList(ref),
		"k8s.io/code-generator/_examples/apiserver/apis/example2.io/v1.TestTypeStatus": schema_apiserver_apis_example2io_v1_TestTypeStatus(ref),
	}
}
...
func schema_apiserver_apis_example2io_v1_TestType(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TestType is a top-level type. A client is created for it.",
				...
				Properties: map[string]spec.Schema{
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("k8s.io/code-generator/_examples/apiserver/apis/example2.io/v1.TestTypeStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/code-generator/_examples/apiserver/apis/example2.io/v1.TestTypeStatus"},
	}
}

func schema_apiserver_apis_example2io_v1_TestTypeList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TestTypeList is a top-level list type. The client methods for lists are automatically created. You are not supposed to create a separated client for this one.",
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("k8s.io/code-generator/_examples/apiserver/apis/example2.io/v1.TestType"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta", "k8s.io/code-generator/_examples/apiserver/apis/example2.io/v1.TestType"},
	}
}

func schema_apiserver_apis_example2io_v1_TestTypeStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
